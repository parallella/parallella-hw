proc ps7_pll_init_data {} {
    ...
    mask_write 0XF8000104 0x0007F000 0x00032000
    ...
    mask_write 0XF8000108 0x0007F000 0x00028000
...
proc ps7_clock_init_data {} {
    ...
    mask_write 0XF8000140 0x03F03F71 0x00100C31
    mask_write 0XF800014C 0x00003F31 0x00000721
    mask_write 0XF8000150 0x00003F33 0x00001802
...
proc ps7_mio_init_data {} {
    ...
    mask_write 0XF8000B6C 0x00007FFF 0x00000E05
    ...
    mask_write 0XF8000700 0x00003F01 0x00000601
    ...
    mask_write 0XF8000834 0x003F0000 0x00000000
    mask_write 0XF8000004 0x0000FFFF 0x0000767B
}
